...
revision: str = "81ffaec36551"
down_revision: str | None = "00f619d920ac"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

PERMISSIONS: dict[str, str] = {
    "entretien:lire": "Consulter les entretiens de son périmètre",
    "entretien:creer": "Créer un entretien",
    "tableau_bord:lire": "Consulter l'avancement (statuts seuls)",
}

ATTRIBUTIONS: dict[str, tuple[str, ...]] = {
    "ADMIN": tuple(PERMISSIONS),
    "RH": ("entretien:lire", "entretien:creer", "tableau_bord:lire"),
    "MANAGER": ("entretien:lire", "entretien:creer"),
    "COLLABORATEUR": ("entretien:lire",),
}
