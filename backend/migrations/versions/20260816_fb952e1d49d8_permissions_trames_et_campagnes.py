...
revision: str = "fb952e1d49d8"
down_revision: str | None = "8e78f852e2b9"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

PERMISSIONS: dict[str, str] = {
    "template:lire": "Consulter les trames",
    "template:creer": "Créer une trame",
    "template:modifier": "Modifier une trame en brouillon",
    "template:publier": "Publier une trame",
    "campagne:lire": "Consulter les campagnes",
    "campagne:creer": "Créer une campagne",
    "campagne:ouvrir": "Ouvrir une campagne",
    "campagne:cloturer": "Clôturer une campagne",
}

ATTRIBUTIONS: dict[str, tuple[str, ...]] = {
    "ADMIN": tuple(PERMISSIONS),
    "RH": tuple(PERMISSIONS),
    "MANAGER": ("template:lire", "campagne:lire"),
}
